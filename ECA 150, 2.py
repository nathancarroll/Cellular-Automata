...
#Next steps:
#-Fix the grid so there's not the wasted space on top.
...
##        grid = Grid(width, height)
        ...
        xc,yc = grid.center     #This is the upgraded code from the comment in the post.
...
##                    grid.set( xc - raw_x, yc - raw_y ) #Commenting out 3 of these
                    grid.set( xc - raw_y, yc + raw_x )   #makes it so there's just
##                    grid.set( xc + raw_y, yc - raw_x ) #1 instead of 4 images of it.
