...
#7.3: Made the naming function more practical.

#Possible next steps:
#-Adapt code for next-nearest neighbors.
...
def test_grid(n, grid_width, pixel_size, rule,
    ...
    r = PygameRenderer(n, grid_width, pixel_size, colors, rule, values, number_of_neighbors) #The last 3 are just to help with file-naming.
    r.render(grid)
    while True:
        r.refresh()
...
if __name__ == '__main__':
    ...
    #For more complex CA.
##    test_grid(800, 800, 1, 105330488576562345234538380193503486834235634352234234234534523452345345345634855675668, 0, [4, 3, 2, 1, 0], 3,
...
##    test_grid(10000, 1500, 1, 1060606, 0, [2, 1, 0], 3,  #Interesting particles and domains.
##              {'2': (0, 0, 255), '1': (0, 0, 0), '0': (255, 255, 255)})
##    test_grid(4000, 1500, 1, 52606068585838380193034868634855675675, 0, [3, 2, 1, 0], 3, #My favorite so far, but it usually doesn't last longer than 2-3k rows.
##              {'3': (255, 0, 0), '2': (0, 0, 255), '1': (0, 0, 0), '0': (255, 255, 255)})
##    test_grid(1000, 1000, 1, 59806088575838380193034868634855675674, 0, [3, 2, 1, 0], 3,  #Less dense particles than two below.
##              {'3': (255, 0, 0), '2': (0, 0, 255), '1': (0, 0, 0), '0': (255, 255, 255)})
##    test_grid(20000, 1400, 1, 59806088575838380193034868634855675667, 0, [3, 2, 1, 0], 3, #Very dense particle regions.
##              {'3': (255, 0, 0), '2': (0, 0, 255), '1': (0, 0, 0), '0': (255, 255, 255)})
