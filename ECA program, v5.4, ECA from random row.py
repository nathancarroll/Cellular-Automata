...
#Version 5.4:
#-Got the code so I only had to enter the arguments in test_grid instead of in multiple places

#Possible next steps:
#-Adapt code so it can accommodate more than 2 cell values.
#-Adapt code so it can accommodate more than nearest neighbor.
...
class Generator(object):
    ...
    def create_grid(self, n, grid_width):
        ...
        for index, row in enumerate(self.generate(n, grid_width)): #Had to add `grid_width` here.
            raw_x = index
...
if __name__ == '__main__':
    ...
    test_grid(500, 500, 1, Rules.rule54)
