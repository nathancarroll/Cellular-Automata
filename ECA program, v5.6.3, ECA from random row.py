...
#Possible next steps:
#-Adapt code to take ints as values instead of bools.
#-Adapt code for filters via Shalizi.
#-Add a parameter to inject randomness into the CA.
...
class Generator(object):
    ...
    def create_grid(self, n, grid_width):
        ...
        for row in self.generate(n, grid_width):
            grid.append(row)
...
def test_grid(n = 5, grid_width = 200, pixel_size = 16, rule=Rules.rule150):
    ...
    grid = Generator(rule=rule_dict)(n, grid_width)
