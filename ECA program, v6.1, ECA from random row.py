...
#6.2:
#Fully integrate the ability to use more than 2 values with more than 2 colors.
...
class Generator(object):
    ...
    def _calculate_row_randomness(self, previous_row, randomness=0, values=[1,0]): #Test
        '''Generates the next row based on the previous row. Includes code
        for wrap-around effect.'''
...
if __name__ == '__main__':
    ...
    test_grid(1000, 1000, 1, 110, 0) #For ECA
    #test_grid(200, 200, 4, 106, 0, [2, 1, 0], 3) #For CA beyond nearest neighbor and 2 cell values.
