...
#and changing all "xrange" functions to "range".
...
class Grid(object):
    ...
    def __init__(self, x, y, seed=None):
        ...
        self.height = y
        self.array = []
##        self.center = (int(x / 2), int(y / 2)) #An alternate way to do this, suggested in comments to the code in the post. I can't get it to work but didn't try very hard.
